...
## Sample PowerApps Integration Data

### Story Submission Sample:
```json
{
  "userId": "john.doe@microsoft.com",
  "title": "Leading My First Cross-Functional Project",
  "content": "When I was asked to lead a project involving engineering, design, and marketing teams...",
  "category": "leadership",
...
### Mentorship Preferences Sample:
```json
{
  "userId": "jane.smith@microsoft.com",
